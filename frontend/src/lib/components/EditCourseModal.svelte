  ...
  <div class="modal" in:scale={{ start: 0.96, duration: 200 }}>
    ...
    <div class="modal-header">
        <div class="header-content">
            ...
            <p class="modal-subtitle">Actualiza la información general y el acceso.</p>
        </div>
    ...
    <div class="modal-body-scroll">
        ...
        <form class="course-form" on:submit|preventDefault={handleUpdate}>
            ...
            <div class="students-section">
                ...
                <p class="help-text">Agrega los correos electrónicos de los estudiantes autorizados.</p>
                        ...
                        <div class="tags-grid">
                            {#each students as student, i}
                                <div class="student-tag" transition:scale|local>
                                    ...
                                    <button type="button" class="tag-remove" on:click={() => removeStudent(i)} title="Remover">
                                        &times;
                                    </button>
                                </div>
                            {/each}
    ...
    <div class="modal-footer">
        ...
        <button type="button" class="btn-primary" on:click={handleUpdate} disabled={loading}>
            {#if loading}
...
<style>
  ...
  .modal {
    background: #ffffff; border-radius: 16px; width: 100%; max-width: 550px; height: 85vh;
  ...
  .student-list-container {
    min-height: 100px; max-height: 200px; overflow-y: auto; background: #ffffff;
