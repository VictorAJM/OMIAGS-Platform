<script lang="ts">
  ...
  async function handleQuizCreated(e: CustomEvent) {
    ...
    if (activeContentIndex !== null && contents[activeContentIndex]) {
      ...
      // Save the lesson to persist the association, then redirect
...
>
  <div class="modal" on:click|stopPropagation in:scale={{ start: 0.95 }}>
    ...
    <form
      on:submit|preventDefault={() => handleUpdate(true)}
      class="lesson-form"
    >
      <div class="main-fields">
        ...
        <div class="form-group">
          ...
          <textarea id="desc" rows="2" bind:value={description}></textarea>
        </div>
      </div>
                    ...
                    {#if content.quizId}
                      <div class="quiz-selected">
                        <div class="quiz-info">
                          ...
                          <span class="quiz-id">ID: {content.quizId}</span>
                        </div>
                        <button
                          type="button"
                    ...
                    {:else}
                      <div class="quiz-actions">
                        ...
                        <div class="or-divider">
                          <span>o vincula existente</span>
                        </div>
                        <input
                          type="text"
                          bind:value={content.quizId}
                          placeholder="Pegar ID de Quiz..."
                          class="input-sm"
                        />
                      </div>
                    {/if}
                  {:else if content.type === "pdf"}
                    {#if content.url}
                      <div class="file-preview">
                        ...
                        <a href={content.url} target="_blank" class="view-link"
                          >Ver</a
                        >
                        <button
                          type="button"
